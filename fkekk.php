...
<html>
  <body>
  <div class="sidebar">
    <a href="postfkekk.php">Create Post</a>
  </div>
  <div class="content">
    <h1 class="text_1">Fakulti Kejuruteraan Elektronik & Komputer</h1>
    <?php
        session_start();
        ...
        $sql= "SELECT * FROM infofkekk order by infoNum desc";
        ...
        if ($result->num_rows > 0) {
          ...
          echo "</tr>";
            ...
            {
    ?>
            <tr><td align="right"><a href="updateFkekk.php?infoNum=<?php echo $row["infoNum"];?>" class="update">Edit</a> <a href="deleteFkekk.php?infoNum=<?php echo $row["infoNum"];?>"  class="update">Delete</a></td></tr>
