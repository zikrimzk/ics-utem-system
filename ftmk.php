...
<html>
  ...
  <div class="content">
    <h1 class="text_1">Fakulti Teknologi Maklumat & Komunikasi </h1>
    ...
    <?php
        ...
        $sql= "SELECT * FROM infoftmk order by infoNum desc";
        ...
        if ($result->num_rows > 0) {
          ...
          echo "<td colspan='3' align='left'><center><img src='".$imageurl."' class='image'></center></td>";
            ...
            {
    ?>
            <tr><td align="right"><a href="updateFtmk.php?infoNum=<?php echo $row["infoNum"];?>" class="update">Edit</a> <a href="deleteFtmk.php?infoNum=<?php echo $row["infoNum"];?>"  class="update">Delete</a></td></tr>
