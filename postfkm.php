...
if ($result->num_rows > 0) {
    ...
    echo "<form method = 'post' action = 'processFkm.php'enctype='multipart/form-data'>";
...
<br />
<tr>
<td colspan="2"><input type="submit" name="submit" value= "Create Post"/> <input type="reset" value="Clear Post"/> <a href="fkm.php"><input type="button" value="Cancel"/></a></td>
</tr>
	</table>
	</form>
</center>
