...
<html>
  <body>
  <div class="sidebar">
    <a href="postkasturi.php">Create Post</a>
  </div>
  
  <div class="content">
    <h1 class="text_1"> Blok Kasturi </h1>
    ...
    <?php
        ...
        $sql= "SELECT * FROM infokasturi  order by infoNum desc";
        ...
        if ($result->num_rows > 0) {
          ...
          echo "</tr>";
            ...
            if($row['matrik']== $userid)
              {
      ?>
            <tr><td align="right"><a href="updateKasturi.php?infoNum=<?php echo $row["infoNum"];?>" class="update">Edit</a> <a href="deleteKasturi.php?infoNum=<?php echo $row["infoNum"];?>"  class="update">Delete</a></td></tr>
