...
$id=$_REQUEST['infoNum'];
$sql =" SELECT * FROM infofkekk WHERE infoNum= '".$id."'";
...
echo "<form method='post' action='updateFkekkE.php' enctype='multipart/form-data'>";
...
echo "<br />";
echo "<tr><td colspan='2'><input type='submit' name='submit' value= 'Edit Post'/> <input type='reset' value='Clear Post'/> <a href='ftmk.php'><input type='button' value='Cancel'/></a></td></tr>";
echo "</table>";
echo "</form>";
echo "</center>";
}
