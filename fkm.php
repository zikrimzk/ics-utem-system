...
<html>
  ...
  <div class="sidebar">
    <a href="postfkm.php">Create Post</a>
  </div>
  
  <div class="content">
    <h1 class="text_1">Fakulti Kejuruteraan Mekanikal</h1>
...
$sql= "SELECT * FROM infofkm order by infoNum desc";
...
if ($result->num_rows > 0) {
    ...
    {
    ?>
    <tr><td align="right"><a href="updateFkm.php?infoNum=<?php echo $row["infoNum"];?>" class="update">Edit</a> <a href="deleteFkm.php?infoNum=<?php echo $row["infoNum"];?>"  class="update">Delete</a></td></tr>
