...
<html>
  <body>
  <div class="sidebar">
    <a href="postlekiu.php">Create Post</a>
  </div>
  
  <div class="content">
    <h1 class="text_1"> Blok Lekiu </h1>
    ...
    <?php
      ...
      $sql= "SELECT * FROM infolekiu order by infoNum desc";
      ...
      if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
          ...
          {
    ?>
        <tr><td align="right"><a href="updateLekiu.php?infoNum=<?php echo $row["infoNum"];?>" class="update">Edit</a> <a href="deleteLekiu.php?infoNum=<?php echo $row["infoNum"];?>"  class="update">Delete</a></td></tr>
