<title>ICS Homepage : Staff </title>
<?php
include("head.php");
  ...
  <section class="sec_2">
   <center>
    <table border="0" cellpadding="10" cellspacing="50">
      <tr>
        <th colspan="5"> <h2 class="greet">STAFF ACCESS</h2></th>
      </tr>
      <tr>
        <td align="center"><a href="https://portal.utem.edu.my/iutem/" target="_blank"><img src="image/but_smp.png"  width="3cm"class="button"></a></td>
      ...
      <tr>
        <td align="center" class="text2">Portal</td>
        <td align="center" class="text2">Staff Mail</td>
