...
<html>
  <body>
  <div class="sidebar">
    <a href="postfke.php">Create Post</a>
  </div>
  <div class="content">
    <h1 class="text_1">Fakulti Kejuruteraan Elektrik</h1>           
    <?php
        session_start();
        ...
        $sql= "SELECT * FROM infofke order by infoNum desc";
        ...
        if ($result->num_rows > 0) {
          ...
          echo "</tr>";
            ...
            if($row['matrik']== $userid)
                  {
    ?>
                  <tr><td align="right"><a href="updateFke.php?infoNum=<?php echo $row["infoNum"];?>" class="update">Edit</a> <a href="deleteFke.php?infoNum=<?php echo $row["infoNum"];?>"  class="update">Delete</a></td></tr>
