...
<html>
  <body>
  <div class="sidebar">
    <a href="postjebat.php">Create Post</a>
  </div>
  ...
  <div class="content">
    ...
    ?>
        ...
        <tr><td align="right"><a href="updateJebat.php?infoNum=<?php echo $row["infoNum"];?>" class="update">Edit</a> <a href="deleteJebat.php?infoNum=<?php echo $row["infoNum"];?>"  class="update">Delete</a></td></tr>
